...
export default function Navbar() {
    return (
        <div className="bg-slate-800 w-full h-10 flex m-auto">
            ...
            <div className="absolute border rounded-lg p-1 h-7 my-auto end-2 top-1 border-slate-500">
                <svg color="white" opacity="0.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-5 h-5 float-left  m-auto"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                <input type="text"
